...
::set tablename=cbev2.WebObjCaption
::set modelFile=G:\工程\ISI\saam-lod\crm-models\test\cbev2.WebObjCaption-model.ttl
::set n3Filename=G:\工程\ISI\saam-lod\n3\cbev2.WebObjCaption.n3

::set tablename=cbev2.WebObjDescription
::set modelFile=G:\工程\ISI\saam-lod\crm-models\test\cbev2.WebObjDescription-model.ttl
::set n3Filename=G:\工程\ISI\saam-lod\n3\cbev2.WebObjDescription.n3

set tablename=cbev2.WebObjectImages
set modelFile=G:\工程\ISI\saam-lod\crm-models\test\cbev2.WebObjectImages-model.ttl
set n3Filename=G:\工程\ISI\saam-lod\n3\cbev2.WebObjectImages.n3



echo "Processing %name% file on table tablename ..."
mvn exec:java -Dexec.mainClass="edu.isi.karma.rdf.OfflineRdfGenerator" -Dexec.args=" --sourcetype DB --dbtype SQLServer --hostname lod.isi.edu --username sa --password isi4676 --portnumber 1433 --dbname smithsonian02042014 --tablename %tablename% --modelfilepath %modelFile% --outputfile %n3Filename%" -Dexec.classpathScope=compile >>resutl.txt
